 ...
 */
 ...
 process PROKKA {
	...
	/home/nfs/SOFTWARE/Other/MicroPope/MicroPipe/Scripts/create_database.py    -n ${res_path}/*.ffn -p ${res_path}/*.faa -f ${res_path}/*.fna -g ${res_path}/*.gff -d ${res_path}/Gene.xls
