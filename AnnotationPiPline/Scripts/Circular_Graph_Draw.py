...
'''
	...
	command = "java -jar %s/gview.jar -t 100 -i %s -o %s -l circular -W 2000 -H 2000 -q high -f png"%(gview_root,END.name ,ring_png )
	subprocess.check_output(command.split())
	cir_png = "%s.png"%(os.getpid()+1)
	command ="java -jar %s/gview.jar -t 100 -i %s -s %s -o %s -l circular  -W 1200 -H 1200 -q high -f png" %(gview_root,gbk,gview_root+'/myown.gss',cir_png)
	subprocess.check_output(command.split())
