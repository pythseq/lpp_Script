...
p + scale_size("EnrichFactor")+scale_color_gradient(low="red", high="blue")+theme_few()+facet_grid(.~ontology,scales="free_x",space="free")+theme(legend.position="top,left",axis.text.x=element_text(angle=75,hjust=1.0))
